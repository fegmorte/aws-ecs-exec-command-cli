...
def get_service_arn(profile: str, cluster_name: str) -> list:
    ...
    """
    service_response = get_ecs_data(
        profile=profile, cluster_name=cluster_name, action="list_services"
    )
...
def get_container_name(profile: str, cluster_name: str, task_name: str) -> list:
    ...
    container_response = get_ecs_data(
        profile=profile,
        cluster_name=cluster_name,
        task_name=task_name,
...
def get_log_group(profile: str, container_name: str, task_definition_arn: str) -> str:
    ...
    Returns:
        str: Log group name
    """
    log_group_response = get_ecs_data(
        profile=profile,
